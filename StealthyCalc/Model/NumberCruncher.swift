...
struct NumberCruncher {
    ...
    private var operationsDict = [
        ...
        "sinh": Operation.unary({ sinh($0) }, { "sinh(\($0))" }, false),
        "cosh": Operation.unary({ cosh($0) }, { "cosh(\($0))" }, false),
        "tanh": Operation.unary({ tanh($0) }, { "tanh(\($0))" }, false),
        "sinh⁻¹": Operation.unary({ asinh($0) }, { "sinh⁻¹(\($0))"}, false),
        "cosh⁻¹": Operation.unary({ acosh($0) }, { "cosh⁻¹(\($0))"}, false),
        "tanh⁻¹": Operation.unary({ atanh($0) }, { "tanh⁻¹(\($0))"}, false),
        //DEGREES
